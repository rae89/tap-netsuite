            ...
            if field["type"] == "String":
                ...
                custom_fields.append(
                    that.ns_client.SelectCustomFieldRef(
                        ...
                        value=self.ns_client.ListOrRecordRef(internalId=field["value"]),
                    )
                )
...
class Customers(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        search_record = self.ns_client.basic_search_factory(
            type_name="Customer", lastModifiedDate=last_modified_date
        )
        ps = PaginatedSearch(
...
class InventoryItem(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        record_type_search_field = self.ns_client.SearchStringField(
            searchValue="InventoryItem", operator="contains"
        )
        search_record = self.ns_client.basic_search_factory(
            type_name="Item",
...
class Opportunity(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        record_type_search_field = self.ns_client.SearchStringField(
            searchValue="Opportunity", operator="contains"
        )
...
class SalesOrders(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        record_type_search_field = self.ns_client.SearchStringField(
            searchValue="SalesOrder", operator="contains"
        )
        basic_search = self.ns_client.basic_search_factory(
            "Transaction",
            lastModifiedDate=last_modified_date,
...
class ConsolidatedExchangeRateSearchBasic(ApiBase):
    def __init__(self, ns_client):
        ApiBase.__init__(
            self, ns_client=ns_client, type_name="ConsolidatedExchangeRateSearchBasic"
        )
    ...
    def get_all_generator(self, page_size=200, posting_period=None):
        record_type_search_field = self.ns_client.SearchStringField(
            searchValue="ConsolidatedExchangeRateSearchBasic", operator="contains"
        )
        basic_search = self.ns_client.basic_search_factory(
        ...
        paginated_search = PaginatedSearch(
            client=self.ns_client,
            basic_search=basic_search,
            type_name="ConsolidatedExchangeRateSearchBasic",
            pageSize=page_size,
        )
...
class InventoryTransfer(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        record_type_search_field = self.ns_client.SearchStringField(
            searchValue="InventoryTransfer", operator="contains"
        )
        basic_search = self.ns_client.basic_search_factory(
            "Transaction",
            recordType=record_type_search_field,
...
class Items(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        search_record = self.ns_client.basic_search_factory(
            type_name="Item", lastModifiedDate=last_modified_date
        )
        ps = PaginatedSearch(
            client=self.ns_client,
            type_name="Item",
...
class InventoryAdjustment(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        record_type_search_field = self.ns_client.SearchStringField(
            searchValue="InventoryAdjustment", operator="contains"
        )
        basic_search = self.ns_client.basic_search_factory(
            "Transaction",
            recordType=record_type_search_field,
...
class VendorBills(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        record_type_search_field = self.ns_client.SearchStringField(
            searchValue="VendorBill", operator="contains"
        )
        basic_search = self.ns_client.basic_search_factory(
            "Transaction",
            recordType=record_type_search_field,
...
class VendorPayments(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        record_type_search_field = self.ns_client.SearchStringField(
            searchValue="VendorPayment", operator="contains"
        )
        basic_search = self.ns_client.basic_search_factory(
            "Transaction",
            recordType=record_type_search_field,
...
class JournalEntries(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        record_type_search_field = self.ns_client.SearchStringField(
            searchValue="JournalEntry", operator="contains"
        )
        basic_search = self.ns_client.basic_search_factory(
            "Transaction",
            lastModifiedDate=last_modified_date,
...
class Invoice(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        record_type_search_field = self.ns_client.SearchStringField(
            searchValue="Invoice", operator="contains"
        )
        basic_search = self.ns_client.basic_search_factory(
            "Transaction",
            lastModifiedDate=last_modified_date,
...
class CreditMemos(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        record_type_search_field = self.ns_client.SearchStringField(
            searchValue="CreditMemo", operator="contains"
        )
        basic_search = self.ns_client.basic_search_factory(
            "Transaction",
            lastModifiedDate=last_modified_date,
...
class PurchaseOrder(ApiBase):
    ...
    def get_all_generator(self, page_size=200, last_modified_date=None):
        record_type_search_field = self.ns_client.SearchStringField(
            searchValue="PurchaseOrder", operator="contains"
        )
        basic_search = self.ns_client.basic_search_factory(
            "Transaction",
            lastModifiedDate=last_modified_date,
